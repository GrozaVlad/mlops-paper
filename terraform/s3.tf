...
resource "aws_s3_bucket" "models" {
  ...
  tags = {
    Name        = "${var.project_name}-${var.environment}-models-bucket"
...
# S3 Bucket for Experiment Artifacts
resource "aws_s3_bucket" "artifacts" {
  bucket = "${var.project_name}-${var.environment}-artifacts-${random_string.bucket_suffix.result}"

  tags = {
    Name        = "${var.project_name}-${var.environment}-artifacts-bucket"
    Purpose     = "Experiment artifacts storage"
    Environment = var.environment
  }
}
